...
{
    public partial class FormularioActualizarPrecioProducto : Form
    {
        public FormularioActualizarPrecioProducto()
        {
            InitializeComponent();
            this.CenterToScreen();
            timer1.Enabled = true;
        ...
        private void FormularioActualizarPrecioProducto_Load(object sender, EventArgs e)
        {
